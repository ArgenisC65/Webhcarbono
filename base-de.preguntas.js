...
let baseDePreguntas = [
  {
    ...
    ayuda: "Han originado aumento del nivel de mares, escasez de agua, eventos climáticos inesperados",
  ...
  },
  {
    ...
    respuesta: "En el aire está ocurriendo aumento de gases que atrapan el calor (gases de efecto invernadero)",
    distractores: ["No se está produciendo c02 suficiente", "Disminición de la temperatura gobal", "Aumento de la actividad nuclear"],
  },
  {
    ...
    respuesta: "Dióxido de carbono (Co2), Metano (Ch4), Oxido nitroso (No2)",
    distractores: ["Nitrógeno (N2) y Oxigeno (O2)", "Dióxido de carbono (Co2), Metano (Ch4), Oxigeno (O2)", "Metano (Ch4), Oxido Nitroso (No2), Nitrógeno (N2)"],
  },
  {
    pregunta: "¿Que procesos generan el CO2 en exceso?",
  ...
  {
    pregunta: "¿Como se produce el exceso de metano(ch4)?",
    ayuda: "Las actividades humanas han elevado el contenido de dióxido de carbono de la atmósfera en un 50 % en menos de 200 años.",
  ...
  },
  {
    ...
    distractores: ["Sustituir los automóviles a gasolina por electricos", "Reforestación (Sembrar mas arboles)", "Cuidar la capa de oxono"],
  },
  {
